...
RSpec.describe Okcugit do
  ...
  it 'only shows each contributor once, and they are given in alphabetical order' do
    known_contributor_names = /Horace Williams|Jason Noble|Jeff Casimir|Josh Cheek|Josh Mejia|Lori Culberson|Lovisa Svallingson|Michael Dao|Rachel Warbelow|Samson Brock|Trey Tomlinson/
